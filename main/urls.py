...
from main.views import show_main, search_books, search_books_blank, search_books_flutter, show_books_flutter
...
urlpatterns = [
    ...
    path('show-books-flutter/', show_books_flutter, name="show_books_flutter"),
]
